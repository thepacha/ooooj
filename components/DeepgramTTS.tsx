...
const CARTESIA_MODELS = [
  // English
  { id: 'c2ad7092-0447-47ea-948b-61fbb6faf153', name: 'Grace', language: 'English (US)', gender: 'Feminine', description: 'Warm, Clear, Friendly' },
  { id: '2a12b36c-7f9b-4c3a-9f7a-72731b15323a', name: 'Ella', language: 'English (US)', gender: 'Feminine', description: 'Bright, Expressive, Cheerful' },
  { id: '3d83e30f-c31b-4f26-b442-7075feafa53a', name: 'Wade', language: 'English (US)', gender: 'Masculine', description: 'Casual, Comfortable, Natural' },
  { id: '56c7989e-7a5f-4d12-838f-e0f910e7356e', name: 'Tristan', language: 'English (UK)', gender: 'Masculine', description: 'Clear, Professional, Confident' },

  // Turkish
  { id: 'bb2347fe-69e9-4810-873f-ffd759fe8420', name: 'Aylin', language: 'Turkish', gender: 'Feminine', description: 'Natural, Clear, Professional' },
  { id: '8036098f-cff4-401e-bfba-f0a6a6e5e49b', name: 'Elif', language: 'Turkish', gender: 'Feminine', description: 'Warm, Smooth, Expressive' },
  { id: '5a31e4fb-f823-4359-aa91-82c0ae9a991c', name: 'Murat', language: 'Turkish', gender: 'Masculine', description: 'Warm, Confident, Articulate' },
  { id: '91e91d74-8eb4-43cd-97d3-7466c21db00d', name: 'Aykut', language: 'Turkish', gender: 'Masculine', description: 'Clear, Natural, Baritone' },

  // Spanish
  { id: '1cc00672-e9d4-455e-b3fb-31dfb7aad231', name: 'Laura', language: 'Spanish', gender: 'Feminine', description: 'Clear, Warm, Friendly' },
  { id: 'e5e5c8d7-3924-4ff6-981a-cb667034be29', name: 'Regina', language: 'Spanish', gender: 'Feminine', description: 'Expressive, Professional' },
  { id: '3efb11f3-4c0e-43c2-bad5-85ab99e993e2', name: 'Eduardo', language: 'Spanish', gender: 'Masculine', description: 'Calm, Natural, Clear' },
  ...
  // German
  { id: 'b9de4a89-2257-424b-94c2-db18ba68c81a', name: 'Viktoria', language: 'German', gender: 'Feminine', description: 'Charismatic, Warm' },
  { id: '6d4b1416-8d54-4d94-a788-8a802c086544', name: 'Sabine', language: 'German', gender: 'Feminine', description: 'Clear, Professional' },
  { id: '42f14755-88c3-4124-aae3-5cc3a9618e8f', name: 'Jan', language: 'German', gender: 'Masculine', description: 'Casual, Engaging' },
  { id: '2be00b67-d53f-4eb5-89e7-96c224d56fbc', name: 'Dieter', language: 'German', gender: 'Masculine', description: 'Calm, Confident' },

  // Italian
  { id: '90c7d657-9599-4cd0-9ed2-2568359e4d1a', name: 'Sofia', language: 'Italian', gender: 'Feminine', description: 'Clear, Cheerful' },
  { id: '36d94908-c5b9-4014-b521-e69aee5bead0', name: 'Giulia', language: 'Italian', gender: 'Feminine', description: 'Warm, Natural' },
  { id: 'e019ed7e-6079-4467-bc7f-b599a5dccf6f', name: 'Luca', language: 'Italian', gender: 'Masculine', description: 'Engaging, Friendly' },
  { id: '88b329db-85d7-47cc-a5c5-98225a756721', name: 'Giuseppe', language: 'Italian', gender: 'Masculine', description: 'Confident, Clear' },

  // Japanese
  { id: '31c55968-a9f4-4115-8831-3a16952179c8', name: 'Ayumi', language: 'Japanese', gender: 'Feminine', description: 'Polite, Clear' },
  { id: '861213b7-f057-45c8-9527-0f4c144f1a03', name: 'Haruka', language: 'Japanese', gender: 'Feminine', description: 'Expressive, Natural' },
  { id: '6b92f628-be90-497c-8f4c-3b035002df71', name: 'Kenji', language: 'Japanese', gender: 'Masculine', description: 'Calm, Confident' },
  { id: '9436e723-612d-4114-aeb0-fa00d4d639bf', name: 'Katsuya', language: 'Japanese', gender: 'Masculine', description: 'Clear, Professional' },

  // Chinese (Mandarin)
  { id: '7a5d4663-88ae-47b7-808e-8f9b9ee4127b', name: 'Hua', language: 'Chinese (Mandarin)', gender: 'Feminine', description: 'Clear, Elegant' },
  { id: 'bf32f849-7bc9-4b91-8c62-954588efcc30', name: 'Lan', language: 'Chinese (Mandarin)', gender: 'Feminine', description: 'Friendly, Natural' },
  { id: '7e2a44d1-76b8-42b8-9507-fedfe3a803c8', name: 'Jian', language: 'Chinese (Mandarin)', gender: 'Masculine', description: 'Calm, Confident' },
  { id: 'eda5bbff-1ff1-4886-8ef1-4e69a77640a0', name: 'Kai', language: 'Chinese (Mandarin)', gender: 'Masculine', description: 'Professional, Clear' },

  // Korean
  { id: '4dd4630e-19e0-4243-bca0-676ff85119b7', name: 'Haeun', language: 'Korean', gender: 'Feminine', description: 'Friendly, Natural' },
  { id: 'cac92886-4b7c-4bc1-a524-e0f79c0381be', name: 'Yuna', language: 'Korean', gender: 'Feminine', description: 'Expressive, Cheerful' },
  { id: 'f7755efb-1848-4321-aa22-5e5be5d32486', name: 'Ryeowook', language: 'Korean', gender: 'Masculine', description: 'Warm, Clear' },
  { id: '537a82ae-4926-4bfb-9aec-aff0b80a12a5', name: 'Minho', language: 'Korean', gender: 'Masculine', description: 'Professional, Confident' },

  // Portuguese
  { id: 'c9611be8-aae9-4a93-bb1c-98dd6b7d52a4', name: 'Isabella', language: 'Portuguese', gender: 'Feminine', description: 'Warm, Natural' },
  { id: '2f4d204f-a5dc-4196-81bc-155986b76ab6', name: 'Mirella', language: 'Portuguese', gender: 'Feminine', description: 'Clear, Expressive' },
  { id: 'b603811e-54c2-4a0a-8854-09eab9ffa63f', name: 'Bruno', language: 'Portuguese', gender: 'Masculine', description: 'Friendly, Confident' },
  { id: '07b6f895-78b9-4921-8e10-8a21c99c2e8a', name: 'Rafael', language: 'Portuguese', gender: 'Masculine', description: 'Professional, Warm' },

  // Russian
  { id: '25b7aaa6-1670-42dc-b791-419322400803', name: 'Daria', language: 'Russian', gender: 'Feminine', description: 'Clear, Expressive' },
  { id: '7a62541e-5492-410e-95ff-3abd096fce87', name: 'Natalia', language: 'Russian', gender: 'Feminine', description: 'Warm, Friendly' },
  { id: '1e4176b1-3db9-44d6-a601-4fe68b041942', name: 'Sergei', language: 'Russian', gender: 'Masculine', description: 'Calm, Clear' },
  { id: '888b7df4-e165-4852-bfec-0ab2b96aaa46', name: 'Dmitri', language: 'Russian', gender: 'Masculine', description: 'Professional, Deep' },

  // Dutch
  { id: '225ba8cf-9fc2-4371-a78c-fe38ba38898a', name: 'Anneliese', language: 'Dutch', gender: 'Feminine', description: 'Warm, Friendly' },
  { id: '0eb213fe-4658-45bc-9442-33a48b24b133', name: 'Sanne', language: 'Dutch', gender: 'Feminine', description: 'Clear, Natural' },
  { id: 'af482421-80f4-4379-b00c-a118def29cde', name: 'Lucas', language: 'Dutch', gender: 'Masculine', description: 'Calm, Clear' },
  { id: '4b250449-c635-4b63-bd1d-b654b12ffcd4', name: 'Jeroen', language: 'Dutch', gender: 'Masculine', description: 'Professional, Deep' },

  // Danish
  { id: 'c323c793-41f9-47b8-99dc-9b44b0440b84', name: 'Katrine', language: 'Danish', gender: 'Feminine', description: 'Smooth, Natural' },
  { id: 'eb929394-68e7-4e08-bd2f-e7055728a5e1', name: 'Mette', language: 'Danish', gender: 'Feminine', description: 'Clear, Cheerful' },
  { id: '926e0766-f380-4d77-aeb0-9aa4ebb16b38', name: 'Soren', language: 'Danish', gender: 'Masculine', description: 'Calm, Confident' },
  { id: 'a466f9e2-28eb-4bb7-925c-8e8984950700', name: 'Søren', language: 'Danish', gender: 'Masculine', description: 'Expressive, Clear' }
];
...
export const DeepgramTTS: React.FC = () => {
    ...
    const [selectedModel, setSelectedModel] = useState(CARTESIA_MODELS[0].id);
    ...
    const uniqueLanguages = ['All', ...Array.from(new Set(CARTESIA_MODELS.map(m => m.language)))];
    const uniqueGenders = ['All', ...Array.from(new Set(CARTESIA_MODELS.map(m => m.gender)))];

    const filteredModels = CARTESIA_MODELS.filter(model => {
    ...
    const selectedModelDetails = CARTESIA_MODELS.find(m => m.id === selectedModel);
    ...
    const saveToHistory = (checkedText: string, modelId: string, url: string) => {
        const modelInfo = CARTESIA_MODELS.find(m => m.id === modelId);
    ...
    const handleLoadHistoryItem = (item: PronunciationHistoryItem) => {
        setText(item.text);
        if (CARTESIA_MODELS.some(m => m.id === item.modelId)) {
                                ...
                                <div className="flex flex-col gap-1 lg:col-span-3">
                                    ...
                                    <select 
                                        ...
                                        onChange={(e) => {
                                            ...
                                            const matching = CARTESIA_MODELS.find(m => newLang === 'All' || m.language === newLang);
