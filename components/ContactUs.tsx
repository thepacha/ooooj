    ...
    <div className="min-h-screen bg-[#fafbfc] dark:bg-slate-950 text-slate-900 dark:text-slate-50 flex flex-col font-sans selection:bg-[#0500e2] selection:text-white pb-32 lg:pb-0">
      ...
      <div className="flex-1 w-full pt-44 lg:pt-48 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
          ...
          {/* Right Column - Form */}
          <div className="w-full max-w-xl lg:ml-auto animate-fade-in-zoom relative">
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <p className="text-xs text-center text-slate-500">
                    By submitting this form, you agree to our <button onClick={onPrivacyClick} className="underline hover:text-slate-900">Privacy Policy</button>.
                  </p>
                </form>
              )}
            </div>
