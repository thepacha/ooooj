                        ...
                        <div className="max-w-md mx-auto text-center py-4 flex flex-col items-center justify-center">
                            {isAIPointingAudio ? (
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="font-bold text-slate-900 dark:text-white">Customer is speaking...</p>
                                    <p className="text-xs text-slate-500 mt-1">Listen closely to handle their request!</p>
                                    <button 
                                        onClick={() => {
                                            if (activeAudioRef.current) {
                                                activeAudioRef.current.pause();
                                ...
                                <div className="flex flex-col items-center">
                                    {isRecording ? (
                                        ...
                                        <>
                                            ...
                                            <p className="text-xs text-slate-500 mt-1">Click the microphone to record your response.</p>
                                        </>
                                    )}
                                </div>
                            )}
