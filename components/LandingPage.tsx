...
import { ArrowRight, Check, Zap, Menu, X, BarChart3, MessageSquare, ShieldCheck, Sparkles, PlayCircle, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-white selection:bg-[#0500e2] selection:text-white overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
            <div className="flex items-center gap-2 text-[#0500e2] dark:text-[#4b53fa] cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <div className="hidden lg:flex items-center gap-8 text-sm font-medium text-slate-600 dark:text-slate-300">
                <a href="#features" className="hover:text-[#0500e2] dark:hover:text-white transition-colors">Features</a>
                <a href="#how-it-works" className="hover:text-[#0500e2] dark:hover:text-white transition-colors">How it works</a>
                <button onClick={onPricingClick} className="hover:text-[#0500e2] dark:hover:text-white transition-colors">Pricing</button>
            </div>

            <div className="hidden lg:flex items-center gap-4">
                <button 
                    onClick={onLoginClick} 
                    className="text-sm font-bold text-slate-700 dark:text-slate-200 hover:text-[#0500e2] dark:hover:text-white transition-colors"
                >
                    Log in
                </button>
                <button 
                    onClick={onSignupClick}
                    className="group px-5 py-2.5 bg-[#0500e2] text-white text-sm font-bold rounded-full shadow-lg shadow-blue-600/20 hover:bg-[#0400c0] hover:shadow-blue-600/30 hover:-translate-y-0.5 transition-all flex items-center gap-2"
                >
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 z-[60] bg-white dark:bg-slate-950 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            <div className="p-6 flex flex-col h-full">
                ...
                <div className="flex-1 flex flex-col gap-6 text-2xl font-serif font-bold">
                    <a href="#features" onClick={() => setIsMenuOpen(false)} className="hover:text-[#0500e2]">Features</a>
                    <a href="#how-it-works" onClick={() => setIsMenuOpen(false)} className="hover:text-[#0500e2]">How it works</a>
                    <button onClick={() => { setIsMenuOpen(false); onPricingClick(); }} className="text-left hover:text-[#0500e2]">Pricing</button>
                </div>

                <div className="mt-auto space-y-4">
                     <button 
                        onClick={() => { setIsMenuOpen(false); onLoginClick(); }} 
                        className="w-full py-4 rounded-xl border-2 border-slate-200 dark:border-slate-800 font-bold text-lg"
                    >
                        Log In
                    </button>
                     <button 
                        onClick={() => { setIsMenuOpen(false); onSignupClick(); }} 
                        className="w-full py-4 bg-[#0500e2] text-white rounded-xl font-bold text-lg shadow-xl shadow-blue-600/20"
                    >
                        Get Started
                    </button>
                </div>
